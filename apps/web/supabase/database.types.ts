...
export type Database = {
  public: {
    Tables: {
      class_assignment_attendance: {
        Row: {
          attendance_status: Database['public']['Enums']['attendance_status'];
          created_at: string;
          id: number;
          student_class_assignment_id: number;
          student_id: number;
        };
        Insert: {
          attendance_status: Database['public']['Enums']['attendance_status'];
        ...
        Relationships: [
          {
            foreignKeyName: 'class_assignment_attendance_student_class_assignment_id_fkey';
            columns: ['student_class_assignment_id'];
            isOneToOne: false;
            referencedRelation: 'student_class_assignments';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'class_assignment_attendance_student_id_fkey';
            columns: ['student_id'];
            isOneToOne: false;
      ...
      student_class_subscription: {
        Row: {
          ...
          created_at: string;
          id: number;
          payment_status: Database['public']['Enums']['subscription_status'];
          school_id: string;
          student_id: number;
        };
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: 'student_class_subscription_class_id_fkey';
            columns: ['class_id'];
            isOneToOne: false;
            referencedRelation: 'classes';
            referencedColumns: ['id'];
    ...
    Enums: {
      ...
      plan: 'FREE' | 'PRO';
      subscription_status: 'PAID' | 'NOT_PAID' | 'RECOVERED';
    };
    CompositeTypes: {
      class_record: {
