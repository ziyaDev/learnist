...
import { ActionIcon, Badge, Button, Card, Flex, Group, Image, Text } from '@mantine/core';
import classes from './style.module.css';

const mockdata = {
  image: '/svg/undraw_welcome_cats_thqn.svg',
...
export function VersioningCard({ onDimiss }: { onDimiss: () => void }) {
